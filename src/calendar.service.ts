...
export function eventItemsToDayViewItems<T extends GmEventItem>(items: T[]): GmDayViewItem[] {
  const dayViewItems: GmDayViewItem[] = items./*sort( (a, b): number => {
...
function eventItemToDayViewItem(item: GmEventItem): GmDayViewItem {
...
function itemOverlapsItem(item: GmDayViewItem, compItem: GmDayViewItem): number {
